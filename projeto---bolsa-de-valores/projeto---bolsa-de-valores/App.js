...
export default function App() {
  ...
  const cotacaoDolar = 6.0597;  // Dólar para Real
  const cotacaoEuro = 6.0169;   // Euro para Real
  const cotacaoIene = 0.0376;   // Iene para Real

  const DadosDL = [
    { moeda: 'Dólar', cotacao: `R$ ${cotacaoDolar.toFixed(2)}`, img: require('./tvc_758f71ab754daf6ac2b7b7e9eb4f9398.png') },
    { moeda: 'Euro', cotacao: `R$ ${cotacaoEuro.toFixed(2)}`, img: require('./euro.png') },
    { moeda: 'Iene', cotacao: `R$ ${cotacaoIene.toFixed(4)}`, img: require('./IENE.png') }
  ];
